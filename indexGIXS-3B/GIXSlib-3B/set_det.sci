// -- detector data base --
// set the detector information det_info - 3B
//

// dependencies
// - called from read_image
// - called from calc_spots
// - calls dlib/get_gui_item

// detector database
function det_info=set_det()

    // get detector type from detector pull-down list

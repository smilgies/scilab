...
function plot_info=get_plot_info(plot_info);
    ...
    if buffer~=[] then
        ...
        if version=="scilab-2023.1.0" then
            ...
            // h_label=h_aux.parent; dnw
            
            if h_label~=[] then
                h_label.font_style=fontstyle;
                h_label.font_size=fontsize;
                h_label.font_foreground=fontcolor;
            ...
            if h_rlabel~=[] then
                h_rlabel.font_style=fontstyle;
                h_rlabel.font_size=fontsize;
                h_rlabel.font_foreground=fontcolor;
        ...
        elseif version=="scilab-2026.1.0" | version=="scilab-2026.0.1" then
            ...
            messagebox("unsupported scilab version - use scilab-2026.1.0 or scilab-2023.1.0")
        end

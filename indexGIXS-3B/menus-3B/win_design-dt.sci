...
if screenV>900 then
    my_title="indexGIXS 3B for desktop    (c) Detlef Smilgies 2021-2026";
else
    my_title="indexGIXS 3B for laptop     (c) Detlef Smilgies 2021-2026";
end

level_num=32;   // fixed for now to work with decode fcns
my_win=figure(5,"figure_name",my_title,...

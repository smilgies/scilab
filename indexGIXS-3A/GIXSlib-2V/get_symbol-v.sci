...
function plot_info=get_symbol(plot_info);
    ...
    header(16)= "lines";
    value(16) = ">>>";
    header(17)= "direct&refl beams - symbol";
    ...
    header(21)= "horizon - line style: solid,dash,dot";
    ...
    header(24)="film Yoneda - line style: solid dash,dot";
    ...
    header(27)="sub Yoneda - line style: solide,dash,dot";
